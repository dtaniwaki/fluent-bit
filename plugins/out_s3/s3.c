                      ...
                      struct flb_config *config, void *data)
{
    ...
    flb_plg_info(ctx->ins, "S3 veirfy TLS: %d", ctx->verify_tls);
    ...
    ctx->client_tls = flb_tls_create(ctx->verify_tls,
                                     ins->tls_debug,
                                     ins->tls_vhost,
                                     ins->tls_ca_path,
                                     ins->tls_ca_file,
...
static struct flb_config_map config_map[] = {
    ...
    {
     FLB_CONFIG_MAP_BOOL, "verify_tls", "true",
     0, FLB_TRUE, offsetof(struct flb_s3, verify_tls),
